...
filmdistance_mm=3000;

lens = lensReverse('dgauss.22deg.50.0mm_aperture6.0.json');
...
fit = load('rtf-dgauss.22deg.50mm-reverse.mat');
rtf = fit.fit{1};
...
%% Configurations
fieldHeights_mm = [0 20  0 20 ]
objectFromFront_distances_mm = [36.959 36.959 37.959 37.959];
...
% Add legend
legh=legend([hlens(1) hrtf(1)],'Exact ray tracing','Ray Transfer Function','Including diffraction');
