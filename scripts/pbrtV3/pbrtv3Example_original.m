...
recipe = piRead('/Users/eugeneliu/git_repo/pbrt2ISET/local/livingRoomWideAngle_depth.pbrt','version',3);
recipe_1 = piRead('/Users/eugeneliu/git_repo/pbrt2ISET/FromC4/SimpleScene/SimpleScene.pbrt','version',3);
...
recipe.set('outputFile',fullfile(piRootPath,'tmp',strcat(oiName,'.pbrt')));
