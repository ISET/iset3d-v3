%% The second in a series of scripts introducing iset3d calulcations
%
% Description:
%    This introduction downlaods a file stored in the Remote Data Toolbox
%    site where we keep various larger PBRT files. The script downloads and
%    then renders it.
%
