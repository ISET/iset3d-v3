%% How to render a pbrt image exported from Blender
...
%    Blender with the method above and is included in the iset3d repository
%    NOTE: blender branch
...
%% Translate an object
% Move the sphere along the sphere's negative x-axis
...
%% Scale an object
% Scale the cube along the cube's z-axis
...
targetMaterial = thisR.materials.lib.matte;
