...
BuildingFolder = strcat('/Volumes/group/wandell/data/NN_Camera_', ...
    'Generalization/Pbrt_Assets_Generation/pbrt_assets/streetlight');
cd(BuildingFolder)
count = 0;
% for ii = 1:2
count = count + 1;
fname = fullfile(BuildingFolder, sprintf('streetlight_tall_%03d', 1), ...
    sprintf('streetlight_tall_%03d.pbrt', 1));
