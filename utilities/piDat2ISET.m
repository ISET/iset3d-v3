...
%
% Brief description:
%    We take a dat file from pbrt as input. We write out an optical image.
%
% Inputs
%   inputFile -  Multi-spectral .dat image data generated by pbrt.
%   label     -  Specify the type of data: radiacne, mesh, depth.
% Optional key/value pairs
%   N/A
%
% Output
%   ieObject: optical image(label=radiance);
%                metadatMap(labe=(mesh||depth||material||coordiantes));
%
%
...
p.addParameter('label','radiacne',@(x)ischar(x));
