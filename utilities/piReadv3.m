...
% Read from a version 3 PBRT file.
%
% Syntax:
%   thisR = piReadv3(fname, [varargin])
%
% Description:
%    Read the contents of a v3 PBRT file into the appropriate structure.
%
% Inputs:
%    fname - String. The filename.
%
% Outputs:
%    thisR - Object. The recipe object.
%
...
if ver ~= 3, error('Only PBRT v3 Cinema 4D exporter is supported.'); end
...
%% Extraction
% Extract lines that correspond to specified keyword if it's exported from
...
if isempty(piBlockExtractV3(txtLines, 'blockName', 'Integrator'))
    ...
    thisR.integrator = piBlockExtractV3(txtLines, ...
