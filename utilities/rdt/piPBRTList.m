...
%
% Outputs:
%    artifacts  - List. A list of the relevant artifacts.
%
% Optional key/value pairs:
%    print      - Boolean. Whether or not default true
%    remote     - String. The string defining the remote directory.
%                 /resources/scenes/pbrt is the default
%    version    - String. The string that defines 'v2' or 'v3' PBRT files.
%
% See Also:
%   piPBRTFetch, piPBRTPush
%

% History:
%    XX/XX/17  BW   SCIEN Stanford team, 2017
