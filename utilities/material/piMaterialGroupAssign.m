...
for ii = 1:length(mlist)
    if  piContains(mlist(ii),'carbody') && ~piContains(mlist(ii),'paint_base')
    ...
    elseif piContains(mlist(ii),'carpaint') && ~piContains(mlist(ii),'paint_base')
        name = cell2mat(mlist(ii));
        material = thisR.materials.list.(name);    % A string labeling the material 
        target = thisR.materials.lib.carpaintmix;  % 
        colorkd = piColorPick('random');
        piMaterialAssign(thisR,material.name,target,'colorkd',colorkd);
    elseif piContains(mlist(ii),'window')
        name = cell2mat(mlist(ii));
    ...
    elseif piContains(mlist(ii),'mirror')
        name = cell2mat(mlist(ii));
        material = thisR.materials.list.(name);
        target = thisR.materials.lib.mirror;
        piMaterialAssign(thisR,material.name,target);
    elseif piContains(mlist(ii),'lightsfront') || piContains(mlist(ii),'lightfront')
        name = cell2mat(mlist(ii));
        material = thisR.materials.list.(name);
        target = thisR.materials.lib.glass;
        piMaterialAssign(thisR,material.name,target);
    elseif piContains(mlist(ii),'lightsback') || piContains(mlist(ii),'lightback')
        name = cell2mat(mlist(ii));
        material = thisR.materials.list.(name);
        target = thisR.materials.lib.glass;
        rgbkr = [1 0.1 0.1];
    ...
    elseif piContains(mlist(ii),'chrome')
        name = cell2mat(mlist(ii));
        material = thisR.materials.list.(name);
        target = thisR.materials.lib.chrome_spd;
        piMaterialAssign(thisR,material.name,target);
    elseif piContains(mlist(ii),'wheel')
        name = cell2mat(mlist(ii));
        material = thisR.materials.list.(name);
        target = thisR.materials.lib.uber;
        piMaterialAssign(thisR,material.name,target);
    elseif piContains(mlist(ii),'rim')
        name = cell2mat(mlist(ii));
        material = thisR.materials.list.(name);
        target = thisR.materials.lib.chrome_spd;
        piMaterialAssign(thisR,material.name,target);
    elseif piContains(mlist(ii),'tire')
        name = cell2mat(mlist(ii));
        material = thisR.materials.list.(name);
        target = thisR.materials.lib.blackrubber;
        piMaterialAssign(thisR,material.name,target);
    elseif piContains(mlist(ii),'plastic')
        name = cell2mat(mlist(ii));
        material = thisR.materials.list.(name);
        target = thisR.materials.lib.plastic;
        piMaterialAssign(thisR,material.name,target);
    elseif piContains(mlist(ii),'metal')
        name = cell2mat(mlist(ii));
        material = thisR.materials.list.(name);
        target = thisR.materials.lib.uber;
        piMaterialAssign(thisR,material.name,target);
    elseif piContains(mlist(ii),'glass')
        name = cell2mat(mlist(ii));
        material = thisR.materials.list.(name);
        target = thisR.materials.lib.glass;
        piMaterialAssign(thisR,material.name,target);
...
%         piMaterialAssign(thisR,material.name,target);
    elseif piContains(mlist(ii),'Bodymat')
        name = cell2mat(mlist(ii));
        material = thisR.materials.list.(name);
    ...
    elseif piContains(mlist(ii),'translucent')
        ...
        piMaterialAssign(thisR,material.name,target);
    elseif piContains(mlist(ii),'wall')
        name = cell2mat(mlist(ii));
