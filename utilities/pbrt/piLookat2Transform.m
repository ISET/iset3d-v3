...
%
% Syntax:
%   world2Cam = piLookat2transform(from, to, up)
%
% Description:
%    The 3 lookAt vectors are converted to the transform matrix
%
% Inputs:
%    from      - Vector. The camera location in world coordinates.
%    to        - Vector. The point in space at which the camera is looking,
%                in world coordinates.
%    up        - Vector. The up direction in world coordinates.
%
% Outputs:
%    world2Cam - Matrix. The matrix representing the world.
%
...
%    * Logic: The transform_matrix is 4x4. It represents how to map each
%      point and vector in the world coordinate into camera coordinate.
