...
% THIS IS DHB DEBUGGING CODE FOR JENKINS.
    renderCommand = sprintf('ls -la /opt/toolboxes/iset3d/local ; ls -la /opt/toolboxes/iset3d/local/chess ; cat /opt/toolboxes/iset3d/local/chess/teapot-area-light.pbrt')
