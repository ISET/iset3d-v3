...
%
% Syntax:
%   iset3dLocalHookTemplate
%
% Description:
%    The goal of this project is to create a simple virtual world, so that
%    we can start playing with AMA analysis using it.
%

% History:
%    02/10/16  VS, dhb  Wrote it.
...
switch (computerName)
    case 'eagleray.psych.upenn.edu'
        switch userID
            case {'dhb'}
                dataDirRoot = ['/Users1/', ...
                    '/Dropbox (Aguirre-Brainard Lab)/IBIO_Analysis'];
            otherwise
